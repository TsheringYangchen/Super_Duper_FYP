...
<div class="row">
    <div class="col">    
      <form action="{{URL::to('/search/filter')}}" method="get" class="form-group"  style="width:35%">
        {{ csrf_field() }}
        <div class="input-group col-6">
            <select class="form-control" name="filter">
              <option value="0">No Violation (Blue)</option>
              <option value="1">1st Voilation (Green)</option>
              <option value="2">2nd Voilation (Yellow)</option>
              <option value="3">3rd Violation/Revoked (Red)</option>
            </select>
            <span class="input-group-btn mr-1">
          <button class="btn btn-secondary" type="submit">Filter By Voilation</button></span>
        </div>
      </form>
    </div>
    ...
    <tbody>
        ...
        <tr>
          ...
          <td class="text-center">
            <a href="license-edit/{{$license->id}}"><i class="fa fa-edit green-color fa-lg"></i></a>
          </td>
        </tr>
        @endforeach
