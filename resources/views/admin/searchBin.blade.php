    ...
    <table class="table table-responsive table-bordered">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <?php foreach(json_decode($issuer->image) as $picture){?><img src="{{ url('uploads/bin').'/'.$picture}}" alt="{{ $issuer->images }}" class="mx-auto d-block img-thumbnail" style="width: 200px; height : 150px">
            <?php } ?>
          </td>
        </tr>
        @endforeach
